...
public final class Settings {
	...
	public static void setSettings() throws IOException {
		...
		props.load(inStream);
		if(props != null) {
			Settings.MAPLINK = props.getProperty(MAP_LINK_NAME);
			Settings.WIDTH_LEFT_DIFFERENCE = Integer.parseInt(props.getProperty(WIDTH_LEFT_NAME));
			Settings.WIDTH_RIGHT_DIFFERENCE = Integer.parseInt(props.getProperty(WIDTH_RIGHT_NAME));
			Settings.HEIGHT_TOP_DIFFERENCE = Integer.parseInt(props.getProperty(HEIGHT_TOP_NAME));
			Settings.HEIGHT_BOTTOM_DIFFERENCE = Integer.parseInt(props.getProperty(HEIGHT_BOTTOM_NAME));
		}
		inStream.close();
	}
}
