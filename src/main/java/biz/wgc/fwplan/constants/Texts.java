...
public class Texts {
	public static final String EDIT_OR_CREATE_TEXT = "Einsatzplan erstellen";
	public static final String ARIAL_FONT = "Arial";
	public static final String PLANNUMBER_TEXT = "Plannummer";
	public static final String TITLE_TEXT = "Titel";
	public static final String DESCRIPTION_TEXT = "Beschreibung";
	...
	public static final String IMPORTANT_CONTACTS_TEXT = "Wichtige Kontakte";
